...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements com.hand.ws.ServiceService {
    ...
    private java.lang.String ServicePort_address = "http://localhost:8080/service";
    ...
    public com.hand.ws.Service getServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.hand.ws.Service getServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hand.ws.ServicePortBindingStub _stub = new com.hand.ws.ServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hand.ws.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hand.ws.ServicePortBindingStub _stub = new com.hand.ws.ServicePortBindingStub(new java.net.URL(ServicePort_address), this);
                _stub.setPortName(getServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.hand.com/", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.hand.com/", "ServicePort"));
        }
